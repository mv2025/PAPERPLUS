...
const REAL_NAMES = [
  "Corporate Table Calendar",
  "Executive Table Calendar",
  "Maha Ganpati Desk Calendar",
  "Bhakti Samarpan Desk Series",
  "Aarti Sangrah Desk Series",
  "Radha Madhav Desk Series",
  "Sai Baba Desk Series",
  "Jai Jai Jagannath Prabhu Desk Series",
  "Shree Ganeshaya Namaha Desk Series",
  "Prabhu Aradhana Aarti Sangrah",
  "Radha Krishna Desk Series",
  ...
  "Om-Gayatri Mantra",
  "Tirupati Balaji",
  "Tirupati Balaji Laxmi",
  "Bhagwan Murugan Swami",
  "Neem Karoli Baba",
  "Sai Baba Wall Calendar",
  "Baba Deep Singh Ji",
  "Diwali Pooja",
  "Diwali Pooja Aarti",
