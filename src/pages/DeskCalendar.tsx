...
const CORP_ITEMS = [
  ...
  { code: '301', name: 'BHAKTI SAMARPAN', cat: 'premium', catLabel: 'Desk Accessories', img: asset22 },
  ...
  { code: '1502', name: 'PRABHU ARADHANA', cat: 'devotional', catLabel: 'Devotional', img: asset28 },
  { code: '1503', name: 'RADHA KRISHNA', cat: 'devotional', catLabel: 'Devotional', img: asset29 },
  { code: '1504', name: 'SAI BABA', cat: 'devotional', catLabel: 'Devotional', img: asset30 },
  ...
  { code: '1507', name: 'MOTIVATIONAL', cat: 'motivational', catLabel: 'Motivational', img: asset33 },
  { code: '1508', name: 'MOTIVATION - The will to win', cat: 'motivational', catLabel: 'Motivational', img: asset34 },
  { code: '1509', name: 'INSPIRATION - STAY STRONG • BE BRAVE • GO BEYOND', cat: 'motivational', catLabel: 'Motivational', img: asset35 },
  { code: '1510', name: "DON'T GIVE UP", cat: 'motivational', catLabel: 'Motivational', img: asset36 },
  { code: '1511', name: 'MINDFUL ESCAPE', cat: 'wellness', catLabel: 'Lifestyle & Wellness', img: asset37 },
  ...
  { code: '1514', name: 'ROYAL HERITAGE', cat: 'travel', catLabel: 'Travel & Heritage', img: asset40 },
  { code: '1515', name: 'TRAVEL', cat: 'travel', catLabel: 'Travel & Heritage', img: asset41 },
